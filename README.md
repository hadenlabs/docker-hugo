...
[![Build Status](https://travis-ci.org/hadenlabs/docker-hugo.svg?branch=main)](https://travis-ci.org/hadenlabs/docker-hugo) [![Latest Release](https://img.shields.io/github/release/hadenlabs/docker-hugo.svg)](https://travis-ci.org/hadenlabs/docker-hugo/releases) [![Micro Badger](https://images.microbadger.com/badges/image/hadenlabs/hugo.svg)](http://microbadger.com/images/hadenlabs/hugo)
...
File a GitHub [issue](https://github.com/hadenlabs/docker-hugo/issues), send us an [email][email] or join our [Slack Community][slack].

## Contributing

### Bug Reports & Feature Requests

Please use the [issue tracker](https://github.com/hadenlabs/docker-hugo/issues) to report any bugs or file feature requests.
